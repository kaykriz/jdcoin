...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Jdcoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
	0xa47ad967, 0x8a4ac470, 0xd88bbc12, 0xee6d1303, 0xe34f1203
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Jdcoin is probably already running."), addrBind.ToString().c_str());
        else
